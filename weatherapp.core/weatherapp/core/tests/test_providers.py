...
class TestRP5_Provider(unittest.TestCase):
    """Test case for RP5_Provider class """

    def setUp(self):
        self.app = App()
        self.provider = RP5_Provider(self.app)
    ...
    def test_get_next_day(self):
        ...
        # items are in proper type
        self.assertTrue(type(weather_info['Next_day_temp_max']) is int)
        self.assertTrue(type(weather_info['Next_day_temp_min']) is int)
        self.assertTrue(type(weather_info['Next_day_condition']) is str)


class TestSinoptikProvider(unittest.TestCase):
    """ Tests for SinoptikProvider """

    def setUp(self):
        self.app = App()
        self.provider = SinoptikProvider(self.app)
